    ...
    <main className="flex-1 overflow-x-hidden overflow-y-auto  p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-3 dark:bg-gray-7 bg-white p-4 rounded-lg">
          <h2 className="text-[20px] font-semibold mb-1">Overview</h2>
          <p className='text-[12px] text-[#A0A0A0] font-medium'>Summary</p>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
            {[
              { title: "Total Users", icon: <DollarSign className="h-6 w-6" />, value: "$5k", change: "+10% from yesterday" },
              { title: "Widthraw Requests", icon: <ShoppingCart className="h-6 w-6" />, value: "500", change: "+8% from yesterday" },
              { title: "Total Deposits", icon: <Package className="h-6 w-6" />, value: indexMails.length, change: "+2% from yesterday" },
              { title: "New Users", icon: <Users className="h-6 w-6" />, value: "12", change: "+3% from yesterday" },
            ].map((card, index) => (
