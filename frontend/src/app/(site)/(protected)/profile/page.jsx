...
import { User, Wallet, Settings, LogOut, ChevronRight, Bitcoin, Copy,Link, UserCheck,Landmark,BadgeDollarSign, Coins } from 'lucide-react'
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="flex justify-between items-center py-3 border-b">
              <div className="flex items-center">
                <Coins className="text-purple-500 w-5 h-5 mr-3" />
                <span className="text-gray-700">My Tokens</span>
              </div>
             <Navlink href={'/profile/tokens'}>
              <ChevronRight className="text-gray-400 w-5 h-5" />
             </Navlink>
            </div>
